...
cv2.createTrackbar("Hue Maximum","TrackBars",19,179,empty)
cv2.createTrackbar("Saturation Minimum","TrackBars",110,255,empty)
cv2.createTrackbar("Saturation Maximum","TrackBars",240,255,empty)
cv2.createTrackbar("Value Minimum","TrackBars",153,255,empty)
...
while True:
    ...
    cv2.imshow("Stacked Result Image",imgStack)
